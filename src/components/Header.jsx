      ...
      <div className='flex justify-between items-center w-11/12 max-w-screen-xl mx-auto my-0'>
        ...
        <div className='flex items-center justify-end'>
          ...
          <Link to='/cart-page'>
            ...
            {menuOpen && (
              <div className="fixed top-0 right-0 bottom-0 left-0 bg-white z-50 overflow-y-auto">
                <ul className="space-x-4 absolute top-0 right-0 w-full h-full transition-transform transform">
